...
class SendAssetList extends StatefulWidget {
  const SendAssetList({Key? key}) : super(key: key);

  @override
  State<SendAssetList> createState() => _SendAssetListState();
}

class _SendAssetListState extends State<SendAssetList> {
      ...
      child: InkWell(
        ...
        child: Padding(
          ...
          child: shimmerEnabled
              ...
              : buildBody(titleStyle, subTitleStyle, context),
        ),
      ),
    );
  }
